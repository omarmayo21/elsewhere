...
>
  ...
  <svg className="section-divider-svg-stroke" viewBox="0 0 1 1" preserveAspectRatio="none">
    <path className="section-divider-stroke" d="M0,0" vector-effect="non-scaling-stroke" />
  </svg>
</div>
...
>
  <div className="gallery-fullscreen-slideshow-wrapper">
    <div className="gallery-fullscreen-slideshow-list">
      ...
      <figure className="gallery-fullscreen-slideshow-item" data-slide-url="w8svfoih8qcuqu3od6xxb9ygl2z9q3-zsb73" data-active="true" data-in="true" data-next="true">
        
          <div className="gallery-fullscreen-slideshow-item-wrapper">
            <div className="gallery-fullscreen-slideshow-item-src">
              <div className="gallery-fullscreen-slideshow-item-img" data-animation-role="image">
...
<img alt="The One Alex Gallery" src="/images.squarespace-cdn.com/content/v1/6a61ec232383587ba923bad7/1784802347773-4M0AMC83UCK4XH3X54HA/the+one.jpg" width="1170" height="774" sizes="max(100vw, 113.37209302325581vh)" style={{display: "block", objectPosition: "50% 50%", objectFit: "cover", width: "100%", height: "100%"} as any} loading="lazy" decoding="async" />
      ...
      <figure className="gallery-fullscreen-slideshow-item" data-slide-url="s1v24rpw9s56wahpgabqalukwz5zj0-z8we4">
...
<img className='phpp' alt="A modern architectural rendering of a large, multi-story residential complex with curved and angular buildings featuring rooftop gardens, surrounded by trees and roads." src="/images.squarespace-cdn.com/content/v1/6a61ec232383587ba923bad7/1784802347763-VMD3B8IBQT81JWU2H4L9/The+One+Pre-launch+-3.png" width="3000" height="1500" sizes="max(100vw, 150vh)" style={{display: "none", objectPosition: "50% 50%", objectFit: "cover", width: "100%", height: "100%"} as any} loading="lazy" decoding="async" />
      ...
      <figure className="gallery-fullscreen-slideshow-item" data-slide-url="oe23no0gkeg5f6w9o99gkh4b3rc1p6-nx9af">
...
<img alt="Modern residential complex with a landscaped courtyard featuring a small fountain, walking paths, and people walking and cycling." src="/images.squarespace-cdn.com/content/v1/6a61ec232383587ba923bad7/1784802347749-IJDG2RFGQHU1YAXDN6VC/the+one+landscape.jpg" width="1290" height="1070" sizes="max(100vw, 90.42056074766356vh)" style={{display: "none", objectPosition: "50% 50%", objectFit: "cover", width: "100%", height: "100%"} as any} loading="lazy" decoding="async" />
    ...
    <div className="gallery-fullscreen-slideshow-controls">
      <div className="gallery-fullscreen-slideshow-control">
        <button className="gallery-fullscreen-slideshow-control-btn" data-previous aria-label="Previous Slide">
      ...
      <div className="gallery-fullscreen-slideshow-control">
        <button className="gallery-fullscreen-slideshow-control-btn" data-next aria-label="Next Slide">
          <div className="gallery-fullscreen-slideshow-control-btn-icon">
    ...
    <div className="gallery-fullscreen-slideshow-bullet-nav">
        ...
        <button className="gallery-fullscreen-slideshow-bullet" data-slide-url="w8svfoih8qcuqu3od6xxb9ygl2z9q3-zsb73" data-target="1">
          <span hidden className="js-slideshow-inactive-slide">Slide 1</span>
          <span hidden className="js-slideshow-active-slide">Slide 1 (current slide)</span>
        </button>
      
        <button className="gallery-fullscreen-slideshow-bullet" data-slide-url="s1v24rpw9s56wahpgabqalukwz5zj0-z8we4" data-target="2">
          <span hidden className="js-slideshow-inactive-slide">Slide 2</span>
          <span hidden className="js-slideshow-active-slide">Slide 2 (current slide)</span>
        </button>
      
        <button className="gallery-fullscreen-slideshow-bullet" data-slide-url="oe23no0gkeg5f6w9o99gkh4b3rc1p6-nx9af" data-target="3">
          <span hidden className="js-slideshow-inactive-slide">Slide 3</span>
          <span hidden className="js-slideshow-active-slide">Slide 3 (current slide)</span>
        </button>
      
    </div>
  </div>
  <div className="gallery-lightbox-outer-wrapper" data-lightbox="false" data-controller="Lightbox">
    <div
  role="dialog"
  aria-label="Gallery"
  ...
  data-section-theme=""
>
  <div className="gallery-lightbox-background"></div>

<div className="gallery-lightbox-header">
  <button className="gallery-lightbox-close-btn" aria-label="Close" data-close data-test="gallery-lightbox-close">
    <div className="gallery-lightbox-close-btn-icon">
  ...
  <div className="gallery-lightbox-wrapper">
    <div className="gallery-lightbox-list">
      
        <figure
          className="gallery-lightbox-item"
          data-slide-url="w8svfoih8qcuqu3od6xxb9ygl2z9q3-zsb73"
          
          data-test="gallery-lightbox-item"
        >
          <div className="gallery-lightbox-item-wrapper">
            <div className="gallery-lightbox-item-src">
              <div
                className="
...
<img alt="The One Alex Gallery" src="/images.squarespace-cdn.com/content/v1/6a61ec232383587ba923bad7/1784802347773-4M0AMC83UCK4XH3X54HA/the+one.jpg" width="1170" height="774" sizes="(max-width: 575px) min(88vw - 40px, (100vh - 12vw) * 1.5116279069767442),min(94vw - 40px, (100vh - 6vw) * 1.5116279069767442)" style={{display: "none", objectFit: "contain", width: "100%", height: "100%"} as any} loading="lazy" decoding="async" />
        ...
        <figure
          className="gallery-lightbox-item"
          data-slide-url="s1v24rpw9s56wahpgabqalukwz5zj0-z8we4"
...
<img alt="A modern architectural rendering of a large, multi-story residential complex with curved and angular buildings featuring rooftop gardens, surrounded by trees and roads." src="/images.squarespace-cdn.com/content/v1/6a61ec232383587ba923bad7/1784802347763-VMD3B8IBQT81JWU2H4L9/The+One+Pre-launch+-3.png" width="3000" height="1500" sizes="(max-width: 575px) min(88vw - 40px, (100vh - 12vw) * 2),min(94vw - 40px, (100vh - 6vw) * 2)" style={{display: "none", objectFit: "contain", width: "100%", height: "100%"} as any} loading="lazy" decoding="async" />
        ...
        <figure
          className="gallery-lightbox-item"
          data-slide-url="oe23no0gkeg5f6w9o99gkh4b3rc1p6-nx9af"
...
<img alt="Modern residential complex with a landscaped courtyard featuring a small fountain, walking paths, and people walking and cycling." src="/images.squarespace-cdn.com/content/v1/6a61ec232383587ba923bad7/1784802347749-IJDG2RFGQHU1YAXDN6VC/the+one+landscape.jpg" width="1290" height="1070" sizes="(max-width: 575px) min(88vw - 40px, (100vh - 12vw) * 1.205607476635514),min(94vw - 40px, (100vh - 6vw) * 1.205607476635514)" style={{display: "none", objectFit: "contain", width: "100%", height: "100%"} as any} loading="lazy" decoding="async" />
    ...
    <div className="gallery-lightbox-controls" data-test="gallery-lightbox-controls">
  <div className="gallery-lightbox-control" data-previous data-test="gallery-lightbox-control-previous">
    <button className="gallery-lightbox-control-btn" aria-label="Previous Slide">
      <div className="gallery-lightbox-control-btn-icon">
        <svg className="caret-left-icon--small" viewBox="0 0 9 16">
          <polyline fill="none" strokeMiterlimit="10" points="7.3,14.7 2.5,8 7.3,1.2 "/>
        </svg>
      </div>
  ...
  <div className="gallery-lightbox-control" data-next data-test="gallery-lightbox-control-next">
    <button className="gallery-lightbox-control-btn" aria-label="Next Slide">
      <div className="gallery-lightbox-control-btn-icon">
        <svg className="caret-right-icon--small" viewBox="0 0 9 16">
          <polyline fill="none" strokeMiterlimit="10" points="1.6,1.2 6.5,7.9 1.6,14.7 "/>
        </svg>
...
>
  ...
  >
    <div className="section-background">\n<video src="/videos/Project3.mp4" autoPlay loop muted playsInline preload="metadata" style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", objectFit: "cover", zIndex: 0 }} />
